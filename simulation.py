    ...
    for y in range(height):
        for x in range(width):
            ...
            # --- STATE 49: DARK YOUNG ---
                ...
                for ny, nx in neighbors:
                    cy, cx = ny % height, nx % width
                    if grid[cy][cx] in [0, 1, 2, 3, 4, 39, 40] and new_grid[cy][cx] not in [48, 49]:
                        new_grid[cy][cx] = 49
                        new_grid[y][x] = 6
                        acted = True
                        break
...
<body>
    ...
    <script>
        ...
        const colors = {{
            ...
            48: '#4b5320', // Shub-Niggurath
            49: '#355E3B'  // Dark Young
        }};
