...
def print_grid(grid):
    ...
    chars = {0: "R", 1: "P", 2: "S", 3: "K", 4: "L", 5: "B", 6: "V", 7: "*", 8: "@", 9: "W", 10: "G", 11: "J", 12: "M", 13: "X", 14: "A", 15: "Z", 16: "O", 17: "N", 18: "D", 20: "Y", 21: "H", 25: "I", 26: "C", 31: "T", 32: "E", 33: "l", 34: "U", 35: "Q", 36: "^", 44: "F", 45: "+", 46: "h", 47: "y", 48: "b", 49: "d", 50: "p", 51: "O", 52: "~", 53: "_", 54: ".", 55: "m",  56: "c", 57: "y", 58: "F", 59: "T", 60: "E", 61: "N", 62: "g", 63: "w"}
    for row in grid:
...
# --- STATE 29: RADIOTROPH ---
            ...
            # --- STATE 63: BHOLE ---
                ...
                # Bholes are colossal subterranean wyrms.
                # They move blindly but will instantly devour any entity in their path, leaving Void behind.
                # They are immune to most things, but their immense size causes them to collapse into a Black Hole (5) very rarely.
                if random.random() < 0.001:
                    new_grid[y][x] = 5 # Collapse into Black Hole
                    continue
                ...
                for ny, nx in neighbors:
                    cy, cx = ny % height, nx % width
                    if grid[cy][cx] != 63 and grid[cy][cx] != 5 and grid[cy][cx] != 30 and new_grid[cy][cx] != 63:
                        new_grid[cy][cx] = 63
                        moved = True
                        break

                if not moved:
                    new_grid[y][x] = 63 # Stay put if nowhere to go
                else:
                    new_grid[y][x] = 6 # Leave Void behind
                continue
