...
def print_grid(grid):
    ...
    chars = {0: "R", 1: "P", 2: "S", 3: "K", 4: "L", 5: "B", 6: "V", 7: "*", 8: "@", 9: "W", 10: "G", 11: "J", 12: "M", 13: "X", 14: "A", 15: "Z", 16: "O", 17: "N", 18: "D", 20: "Y", 21: "H", 25: "I", 26: "C", 31: "T", 32: "E", 34: "U", 35: "Q", 36: "^", 44: "F", 45: "+", 46: "h", 47: "y", 48: "s", 49: "d"}
    for row in grid:
        ...
        for x in range(width):
            ...
            # --- STATE 48: SHUB-NIGGURATH ---
                ...
                for ny, nx in neighbors:
                    cy, cx = ny % height, nx % width
                    if grid[cy][cx] == 6 and new_grid[cy][cx] == 6:
                        new_grid[cy][cx] = 48 # Move into Void
                        if random.random() < 0.10:
                            new_grid[y][x] = 49 # Leave Dark Young behind
                        else:
                ...
                for ny, nx in neighbors:
                    cy, cx = ny % height, nx % width
                    if grid[cy][cx] in [0, 1, 2, 3, 4] and random.random() < 0.05:
                        new_grid[cy][cx] = 49 # Corrupt to Dark Young
                continue
            ...
            # --- STATE 49: DARK YOUNG ---
                ...
                for ny, nx in neighbors:
                    cy, cx = ny % height, nx % width
                    if grid[cy][cx] == 6 and new_grid[cy][cx] == 6:
                        new_grid[cy][cx] = 49 # Move into Void
                        new_grid[y][x] = 6
                        moved = True
                        break
                if not moved:
                ...
                for ny, nx in neighbors:
                    cy, cx = ny % height, nx % width
                    if grid[cy][cx] in [0, 1, 2, 3, 4, 39]:
                        new_grid[cy][cx] = 6 # Consume lifeforms and Investigators
                continue
...
<body>
    ...
    <script>
        ...
        const colors = {{
            ...
            48: '#4a2f1d', // Shub-Niggurath
            49: '#2e1f13'  // Dark Young
        }};
