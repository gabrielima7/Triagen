...
# --- STATE 29: RADIOTROPH ---
            ...
            # --- STATE 63: BHOLE ---
                ...
                for ny, nx in neighbors:
                    cy, cx = ny % height, nx % width
                    if grid[cy][cx] not in [6, 7, 8, 9, 25, 27, 28, 32, 63]:
                        new_grid[cy][cx] = 63
                        moved = True
                        break
                if not moved:
